...
use App\AverageScoreStrategies\WeekAverageScoreStrategy;

class WeekAverageScoreStrategyTest extends TestCase
{
    public function testItReturnsEmptyCollection()
    {
        ...
        $strategy = new WeekAverageScoreStrategy($repository);
    ...
    public function testItReturnsFilledCollection()
    {
        ...
        $this->assertEquals(
            new ScoreDTO(6, 35.0, (new \DateTime('-1 year -1 month'))->format('Y-W')),
            $result[0]
        );
    }
}
